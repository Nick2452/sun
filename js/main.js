$(function(){
    $('.info-tabs__item').on('click', function (e) {
        ...
        $('.info-tabs__items').removeClass('.info-tabs__item--active');
        $(this).addClass('.info-tabs__item--active');

        $('.info-tabs__content').removeClass('.info-tabs__item--active');
        $($(this).attr('htef')).addClass('.info-tabs__item--active');
